...
@"PseudoConstant?$0" = global [4 x i8] c"JJJ\00"
@"PseudoConstant?$1" = global [4 x i8] c"OOO\00"
...
; <label>:3
	%4 = bitcast [4 x i8]* @"PseudoConstant?$0" to i8*
	%5 = call i32 @puts(i8* %4)
	br label %9

; <label>:6
	%7 = bitcast [4 x i8]* @"PseudoConstant?$1" to i8*
